__title__ = "Pick Objects\nFamily Name"
__doc__ = "This add-in allows the user to select elements \
after running and shows the Family Name of the item selected  in a Task Dialog. \
This allows users to select multiple elements and click the Finish button when done."
